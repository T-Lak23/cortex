...
const MessageList = () => {
  ...
  return (
    <div
      className="flex-1 overflow-y-auto px-6 py-6 space-y-5 [scrollbar-width:none]
        ...
        >
          <div className="flex flex-col gap-1.5">
            ...
            <p className="text-[13px] text-slate-600 max-w-[260px] leading-relaxed">
              Ask me anything - code, ideas, explainations, or just a quick
              question.
            </p>
          </div>
          <div className="flex flex-wrap justify-center gap-2 mt-1">
            {["Write a Netflix code", "Explain Redis", "Build a dashboard"].map(
              (s) => (
                <button
                  key={s}
                  className="text-[12px] text-slate-400 bg-white/[0.04] borrder border-white/[0.07] px-3.5

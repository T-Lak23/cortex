...
const Sidebar = () => {
  ...
  if (collapsed) {
    return (
      <div
        className="hidden lg:flex flex-col items-center w-[56px] h-screen bg-[#0d0f14] 
      border-r border-white/[0.06] py-4 gap-1 shrink-0
      "
      >
        <button
          className="
        flex items-center justify-center w-9 h-9 rounded-xl text-slate-500 hover:text-slate-200
          ...
          {conversations?.map((conv, i) => {
            ...
            return (
              <div
                ...
                className={`*:
              flex items-center gap-2.5 cursor-pointer mb-0.5 px-3 py-2.5 rounded-[10px]
              ...
              >
                <div
                  className={`
                  flex items-center justify-center shrink-0 w-[20px] h-[20px]
        ...
        <div className="relative shrink-0">
          {userData?.avatar && !imageError ? (
            ...
            <div
              className="w-9 h-9 rounded-[10px] bg-white/[0.06] flex items-center
                    justify-center
                  "
            >
  ...
  return (
    <>
      <button
        className="lg:hidden fixed top-2.5 left-4 z-50 flex items-center justify-center w-8
    h-8 rounded-lg bg-[#0d0f14] border border-white/[0.06] text-slate-400 hover:text-slate-200
transition-colors durartion-150 cursor-pointer
  ...
  h-screen shrink-0 bg-[#0d0f14] border-r border-white/[0.06] transition-transform duration-250
  ...
  `}
      >
        ...
        "
            ...
            <button
              onClick={() => setMobilOpen(false)}
              className="lg:hidden flex items-center justify-center w-7 h-7 rounded-lg text-slate-500 hover:text-slate-200 
              hover:bg-white/[0.05] transition-colors duration-150 bg-transparent border-none cursor-pointer
              "
            >
              <X />
          ...
          bg-linear-to-br from-indigo-500 to-violet-700 rounded-xl py-[10px] border-none
...
`}
          ...
          <div className="px-3.5 py-3.5">
            {userData ? (
              <div
                className="flex items-center gap-2.5 cursor-pointer rounded-xl
          ...
          "
              >
                ...
                <div className="flex-1 min-w-0">
                  <p
                    className="
                text-[13.5px] font-semibold text-slate-100 truncate
                "
                  >
                    {userData?.name || "user"}
                  </p>
                ...
                <div className="flex gap-1">
                  <button
                    className="
                flex items-center justify-center w-7 h-7 rounded-[7px] border-none
                bg-transparent text-yellow-600 cursor-pointer hover:bg-white[0.08]
                ...
                "
                  ...
                  <button
                    className="
                 flex items-center justify-center w-7 h-7 rounded-[7px] border-none
                bg-transparent text-slate-600 cursor-pointer hover:bg-white[0.08]
                hover:text-slate-400 transition-all duration-150
            ...
            text-slate-200 bg-white/[0.05] border-white/[0.08] rounded-xl py-[11px]

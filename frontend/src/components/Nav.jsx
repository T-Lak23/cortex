...
const Nav = () => {
  ...
  return (
    selectedConversation && (
      <div
        className="h-14 flex  gap-2.5 items-center px-5 border-b border-white/[0.06]
  bg-[#0d0f14]
  "
      >
        ...
        <div
          className="text-[-10px] font-medium text-slate-600 bg-white/[0.04] border border-white/[0.06] px-2
      py-0.5 rounded-full
      "
        >
